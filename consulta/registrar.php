...
<IMG SRC="../images/luz.png" ALIGN="right"  WIDTH=400 HEIGHT=400 >
    ...
    <div class="container" >
        ...
        <div class="panel panel-primary">
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="area">Area donde se atendio el paciente:</label></td><td><input title="Solo se aceptan letras" pattern="[\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ]+"  type="text" class="form-control" name="area" id="area" placeholder="Ingrese el Area"  required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre del Doctor:</label></td><td><input title="Solo se aceptan letras" pattern="[\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ]+"  type="text" class="form-control" name="doc" id="doc" placeholder="Ingrese el Nombre del Doctor"  required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                      <tr class="espacio">
