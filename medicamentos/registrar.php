  ...
  <!-- <IMG SRC="../images/luz.png" ALIGN="right"  WIDTH=400 HEIGHT=400 > -->
    ...
    <div class="container" >
        ...
        <div class="panel panel-primary">
                      ...
                      <table width="100%">
                      <form action="alta_medicamentos.php" method="post" id="frmmedicamentos">
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre:</label></td><td><input type="text" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" class="form-control" name="nombre" id="nombre" placeholder="Ingrese el nombre" autofocus required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                       <tr class="espacio"> 
                      <td align="right"> <label for="codigo">Codigo:</label></td><td><input type="text" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" class="form-control" name="codigo" id="codigo" placeholder="Ingrese el codigo "  required ></td>
                      </tr>
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="marca">Marca:</label></td><td><input type="text" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" class="form-control" name="marca" id="marca" placeholder="Ingrese su marca"  required ></td>
                      </tr>
                      
                      
                      <tr class="espacio"> 
                      <td align="right"> <label for="cant">Cantidad:</label></td><td><input type="number" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" class="form-control" name="cant" id="cant" placeholder="Ingrese la cantidad"  required ></td>
                      </tr>
                      
                      <tr>
        			  <td align="center" colspan="2"><input type="submit" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" class="btn btn-primary" value="Registrar"  title="Registrar"></td>
                      </tr>
                  	  </form>
                      </table>
                      <!-- termina la tabla -->
	...
	var frmmedicamentos = document.getElementById("frmmedicamentos");
