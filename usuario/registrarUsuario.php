...
<IMG SRC="../images/luz.png" ALIGN="right"  WIDTH=400 HEIGHT=400 >
    ...
    <div class="container" >
        ...
        <div class="panel panel-primary">
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre Completo:</label></td><td><input title="Solo se aceptan letras" pattern="[\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ]+"   type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese un nombre" autofocus required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                     
                      <tr class="espacio"> 
                      <td align="right"> <label for="usuario">Usuario:</label></td><td><input type="text" class="form-control" name="usuario" id="usuario" placeholder="Ingrese el Usuario"  required ><span id="resultado"</span></td>
                      </tr>
                      <tr class="espacio"> 
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="pass">Contraseña:</label></td><td><input title="Minimo 8 caracteres" type="text" class="form-control" name="pass" id="pass" pattern="[\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ\d]{8}[\d\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ]*" placeholder="Ingrese la contraseña"  required ></td>
                      </tr>
                       <tr class="espacio">
                      <td align="right"><label for="tipo">Tipo:</label></td><td><select  class="form-control" name="tipo" id="tipo" >
