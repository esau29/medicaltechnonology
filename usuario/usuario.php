...
?>	
    ...
    <form action="#" method="post" id="frmbuscar">
     <tr class="espacio">
     <td align="right"> <label for="nombre">Nombre del Usuario:</label></td><td><input type="text" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 0px;" class="form-control" name="nombre" id="nombre" autocomplete="off"></td>
    ...
    <?php
      ...
      $result = mysqli_query($link, "SELECT * FROM usuario WHERE nombre like '$_POST[nombre]%'");
    ...
    if (aceptar) 
    {
    document.location="eliminar_usuario.php?opcion="+id;
    }
    else{
