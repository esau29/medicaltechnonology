...
?>	
    ...
    <div class="col-md-5 col-md-offset-3">
        ...
        <div class="panel panel-primary">
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="tel">Teléfono:</label></td><td><input maxlength="10" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 10px;" type="tel" class="form-control" name="tel" id="tel" required value="<?php echo $consulta['tel'];?>"></td>
                      </tr>
