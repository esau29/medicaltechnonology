...
<!-- <IMG SRC="../images/logo.png" ALIGN="right"  WIDTH=400 HEIGHT=400 > -->
    ...
    <div class="container" >
        ...
        <div class="panel panel-primary">
                      ...
                      <div class="panel-heading">Registrar Citas Medicas</div>
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="nomb">ID del Paciente:</label></td><td><input title="Solo se aceptan numeros" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" type="number" class="form-control" name="nomb" id="nomb" placeholder="Ingresca la ID" autofocus required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="edad">edad:</label></td><td><input maxlength="3" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;"  type="tel" class="form-control" name="edad" id="edad" placeholder="Ingrese la edad"  required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="area">Area donde se atendio el paciente:</label></td><td><input title="Solo se aceptan letras" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" pattern="[\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ]+"  type="text" class="form-control" name="area" id="area" placeholder="Ingrese el Area"  required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre del Doctor:</label></td><td><input title="Solo se aceptan letras" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" pattern="[\sa-zA-ZáéíóúñÁÉÍÓÚÜüÑ]+"  type="text" class="form-control" name="doc" id="doc" placeholder="Ingrese el Nombre del Doctor"  required onkeyup=”javascript:this.value=this.value.toUpperCase();”></td>
                      </tr> 
                      <tr class="espacio">
                      <td align="right"> <label for="fec">Fecha de la Consulta:</label></td><td><input type="text" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" class="form-control" name="fec" id="fec" required readonly></td><td><span><img src="../images/calendar1.gif" width="20px" height="20px" onClick="displayCalendar(document.forms[0].fec,'yyyy-mm-dd',this)"></span></td>
                      </tr>
                      <tr class="espacio"> 
                      <td align="right"> <label for="dia">Diagnostico:</label></td><td><textarea class="form-control" style="border-color: #3c97e8; border-width: 3px; border-radius: 25px; margin-top: 15px;" name="dia" id="dia" placeholder="Ingrese su Diagnostico"  required onkeyup=”javascript:this.value=this.value.toUpperCase();”></textarea></td>
                      </tr>
