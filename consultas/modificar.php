...
?>
    ...
    <div class="col-md-5 col-md-offset-3">
        ...
        <div class="panel panel-primary">
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="nomb">ID del Paciente:</label></td><td><input title="Solo se aceptan numeros"  type="text" class="form-control" name="nomb" id="nomb" autofocus required value="<?php echo $consulta['nomb'];?>"></td>
                      </tr> 
